...
<center>
	...
	$query = " SELECT image_path,image_name FROM users WHERE id='$id'";
	...
	$query = " SELECT users.first_name,users.last_name,users.email,users.password FROM users WHERE users.id = $id";
